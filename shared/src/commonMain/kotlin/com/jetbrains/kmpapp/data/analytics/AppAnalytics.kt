 ...
 *
 * 2. **Опциональная аналитика** (события использования) — включена по
 *    умолчанию, выключается тумблером «Отправлять анонимную статистику»
 *    в настройках (`uschedule_analytics_enabled`).
 *
